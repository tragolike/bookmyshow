  ...
  return <footer className="mt-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm">
                <li><Link to="/about" className="text-gray-500 hover:text-book-primary">About Us</Link></li>
                <li><Link to="/contact" className="text-gray-500 hover:text-book-primary">Contact Us</Link></li>
                <li><Link to="/careers" className="text-gray-500 hover:text-book-primary">Careers</Link></li>
                <li><Link to="/help" className="text-gray-500 hover:text-book-primary">Help & Support</Link></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm">
                <li><Link to="/terms" className="text-gray-500 hover:text-book-primary">Terms & Conditions</Link></li>
                <li><Link to="/privacy" className="text-gray-500 hover:text-book-primary">Privacy Policy</Link></li>
                <li><Link to="/faq" className="text-gray-500 hover:text-book-primary">FAQs</Link></li>
                <li><Link to="/corporate" className="text-gray-500 hover:text-book-primary">Corporate Bookings</Link></li>
              </ul>
            </div>
      ...
      <div className="md:hidden fixed bottom-0 left-0 right-0 bg-white border-t border-gray-200 z-50">
        <div className="grid grid-cols-4 h-16">
          ...
          <Link to="/movies" className="navigation-item">
            <Film className="w-5 h-5" />
            <span className="text-xs mt-1">Movies</span>
          </Link>
          <Link to="/events" className="navigation-item">
